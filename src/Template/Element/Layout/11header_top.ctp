            ...
            <div class="col-lg-8 col-md-7">
                <div class="header_top_settings text-right">
                    <ul>
                        ...
                        <li v-if="localStorage.hasOwnProperty('_u_ss_isset')"><login/></li>
                        <li v-else><?= $this->Html->link('เข้าสู่ระบบ', ['controller' => 'login', 'action' => 'index']) ?> | <?= $this->Html->link('สมัครสมาชิก', ['controller' => 'register', 'action' => 'index']) ?></li>
                    </ul>
                </div>
            </div>
        </div>
